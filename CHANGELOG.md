...
- **Non-Elixir source safety** — source-backed and file-backed smell checks now skip non-Elixir module files contributed by plugin frontends instead of parsing or inspecting them as Elixir source.
